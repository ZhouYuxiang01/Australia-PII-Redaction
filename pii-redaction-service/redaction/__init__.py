...
Public surface:
  ...
  - backends: RedactionBackend ABC + hybrid OPF/Qwen registry
...
A typical embedding (no FastAPI) looks like:
    ...
    backend = build_backend_from_path("configs/backends/hybrid-opf-qwen9b-hn.json")
    policy  = load_json("configs/policies/hybrid-80class-v2-4b.json")
